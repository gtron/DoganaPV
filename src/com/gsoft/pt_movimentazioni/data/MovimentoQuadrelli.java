...
public class MovimentoQuadrelli {
	...
	public void setData_em_form(FormattedDate data_em_form) {
     ...
     */
    public void setNumeroCataste(Integer numeroCataste) {
     ...
     */
    public void setNumeroProgressivo(Double numeroProgressivo) {
     ...
     */
    public void setPesoFattura(Integer pesoFattura) {
        this.pesoFattura=pesoFattura;
    }
    public void setPesoFattura( String p ) {
        try {
            this.pesoFattura = new Integer( p );
        }
        catch (Exception e ) {
     ...
     */
    public void setPesoPartenza(Integer pesoPartenza) {
        this.pesoPartenza=pesoPartenza;
    }
    public void setPesoPartenza( String p ) {
        try {
            this.pesoPartenza = new Integer( p );
        }
        catch (Exception e ) {
            this.pesoPartenza = null ;
        }
    }
    ...
    public void setCodiceFornitore(String codFornitore) {
    ...
    public Merce getMerce() throws Exception {
        if ( merce == null ){
            this.merce = (Merce) Merce.newAdapter().getByKey( codiceMerce ) ;
        }
        return merce; 
    }
     ...
     */
    public void setNave(Integer codNave ) {
	...
	public static synchronized MovimentoQuadrelliAdapter newAdapter(IDatabase2 db) throws Exception {		
